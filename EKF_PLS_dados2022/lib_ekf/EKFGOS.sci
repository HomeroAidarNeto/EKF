...
//Variáveis para o EKF    
    sigy = [0.0329816   0.0187083   0.0117486   0.0134983   0.0014765  0  0] //Obtido rodando main-multi com mesmo pretrat e dados - RMSECV pro numero otimo de regressores (mol/L)
    sigx    = ones(1,nx)*0.01
    sigx(1,9) = 1e-8
