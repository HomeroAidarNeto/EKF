...
x0=[]
absor0 = []
for i=[1,2,4,5] // 1 e 5 estão ruins
    if i<10 then
...
texp  = texp0([1:5:nexp]) //tempo experimental pega texp0 de 5 em 5 minutos, começa em 1 pq?

absorinf0 = absorinf0([1 [1:5:nexp]+1],:) //1° linha = lambdas, depois pega absorbancias em cada tempo experimental, como se fosse uma sonda medindo de n em n pontos, pro xinf0 é a memsa coisa
xinf0 = xinf0([1:5:nexp],:) //isto supõe que as concentrações e absorbancias corrspondem ao tempo, 600 medidas demoraram 600 minutos, como arrumamos isso?
