...
kinf = [5 5 5 5 5]; //kinf está relacionado com os componentes que estão contidos na amostra (não colocar muito )
//------------------------------------------------------------------
...
texp0   =[1:1:600]' 
t      = [0:1:600]' //tempo do modelo começa em 0 
texp  = texp0([1:5:600]) //tempo experimental pega texp0 de 5 em 5 minutos, começa em 1 pq?

absorinf0 = absorinf0([1 [1:5:600]+1],:) //1° linha = lambdas, depois pega absorbancias em cada tempo experimental, como se fosse uma sonda medindo de n em n pontos, pro xinf0 é a memsa coisa
xinf0 = xinf0([1:5:600],:) //isto supõe que as concentrações e absorbancias corrspondem ao tempo, 600 medidas demoraram 600 minutos, como arrumamos isso?
...
//clf(1); scf(1); plot(Xinf_conc,xinf0,'o');
pause
