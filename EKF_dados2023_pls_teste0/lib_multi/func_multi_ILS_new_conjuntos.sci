function [Xp,Xpval,Par_norm,absor,x] = func_multi_ILS_new_conjuntos(Selecao,optkini,lini,kmax,nc,cname,unid,x0,absor0,frac_test,dadosteste,OptimModel,pretreat,analysis,outlier,gravarXval,index)
    ...
    exec('lib_multi/func_analysis_conjuntos.sci');
    ...
    [absor,lambda,x,ifig]=func_analysis_conjuntos(analysis,absor,lambda,x,ifig)
    ...
    Erros = [RMSECV,RMSEcal,RMSEtest,RMSEajtest]
    nomearq = 'Erros'+string(index)
    fprintfMat(nomearq, Erros)
